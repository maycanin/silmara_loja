...
              />
          ...
          <h1 className="text-4xl md:text-4xl font-bold text-rose-900 mb-6">
            Beleza e elegância <span className="text-transparent bg-clip-text bg-gradient-to-r from-rose-600 to-pink-600">para o seu dia a dia.</span>
          </h1>
          
          <p className="text-xl text-rose-700 mb-8 max-w-3xl mx-auto">
            Descubra nossa coleção exclusiva de semi-jóias, perfumaria, maquiagem e moda íntima. 
            Peças únicas para realçar sua elegância natural.
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-rose-600 text-lg max-w-2xl mx-auto">
              Encontre exatamente o que você procura em nossa seleção cuidadosa de produtos
            </p>
          </div>
                ...
                <div className="aspect-square bg-gradient-to-br from-rose-100 to-pink-100 flex items-center justify-center">
                  <div className="text-center">
                    <div className="w-16 h-16 mx-auto mb-4 bg-gradient-to-br from-rose-500 to-pink-500 rounded-full flex items-center justify-center">
                      {category.slug === 'semi-joias' && <Sparkles className="w-8 h-8 text-white" />}
                      {category.slug === 'perfumaria' && <Heart className="w-8 h-8 text-white" />}
                      {category.slug === 'maquiagem' && <Star className="w-8 h-8 text-white" />}
                      {category.slug === 'moda-intima' && <Heart className="w-8 h-8 text-white" />}
                    </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="font-bold text-xl text-rose-900 mb-2">Qualidade Garantida</h3>
              <p className="text-rose-600">Produtos selecionados com o máximo cuidado e qualidade</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-bold text-xl text-rose-900 mb-2">Atendimento Personalizado</h3>
              <p className="text-rose-600">Suporte dedicado via WhatsApp para suas dúvidas</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-bold text-xl text-rose-900 mb-2">Novidades Sempre</h3>
              <p className="text-rose-600">Lançamentos frequentes e tendências atualizadas</p>
            </div>
          </div>
        </div>
      </section>
